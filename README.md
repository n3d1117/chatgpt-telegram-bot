...
- [x] (NEW!) Localized bot language
  - Available languages :gb: :de: :ru: :tr: :it: :es: :indonesia: :nl:
...
| `BOT_LANGUAGE`                     | Language of general bot messages. Currently available: `en`, `de`, `ru`, `tr`, `it`, `es`, `id`, `nl`.  **Note** [Contribute additional translations](https://github.com/n3d1117/chatgpt-telegram-bot/discussions/219) | `en`                               |
