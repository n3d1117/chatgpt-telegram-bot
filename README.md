...
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| `SUPER_ADMIN_USER_ID`  | The super admin User ID. Notifications about new users who want to use the bot will be sent to this account, which includes their User ID.  | `none`          |
