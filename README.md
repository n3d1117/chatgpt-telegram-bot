...
|------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|
| `ALLOWED_TELEGRAM_GROUP_IDS`             | A comma-separated list of Telegram Group IDs (e.g. starts with a minus `-12345678`) in `ALLOWED_TELEGRAM_GROUP_IDS` where every user in this group is implicitly allowed to interact with the bot  **Note**: by default, no allowed Groups IDs are set, therefore limiting use by `ALLOWED_TELEGRAM_USER_IDS` instead.                                    | ` `                            |
